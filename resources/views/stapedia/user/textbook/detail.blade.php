            ...
            <div class="w-full">
                <ul class="flex mb-0 list-none flex-wrap pt-3 pb-4 flex-row">
                    <li class="-mb-px mr-2 last:mr-0 flex-auto text-center">
                        <a class="text-xs font-bold uppercase px-5 py-3 shadow-lg rounded block leading-normal text-white bg-black"
                        ...
                        <div class="tab-content tab-space">
                            <div class="block" id="tab-profile">
                                <div class="w-full px-4 py-6 sm:px-6 lg:px-8 lg:py-4 mx-auto">
                                    ...
                                    @endphp
                                    <div class="table-scroll max-h-96 overflow-scroll">
                                        <x-stapedia.parts.table :headers="$headers" :contents="$contents"/>
                                    </div>
                                </div>
                            </div>
